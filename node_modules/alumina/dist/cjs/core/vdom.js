...
exports.patch = exports.mount = void 0;
...
// ------------------------------------------------------------
function mount(parentDom, vnode, insertBeforeTarget = null) {
    let dom;
    if (vnode.vtype === 'vBlank') {
        ...
        dom = isSvg
            ? document.createElementNS(constants_1.svgNs, vnode.tagName)
            : document.createElement(vnode.tagName);
        (0, dom_1.applyDomAttributes)(dom, vnode, undefined);
        ...
        parentDom.insertBefore(dom, insertBeforeTarget);
        constants_1.interactivePropKeys.forEach((key) => {
        ...
        const renderRes = vnode.componentWrapper.mount(vnode.state.componentState, vnode.props) || (0, jsx_1.createVBlank)(null);
...
exports.mount = mount;
// ------------------------------------------------------------
function unmount(parentDom, oldVNode) {
...
// ------------------------------------------------------------
function patchFc(parentDom, newVNode, oldVNode) {
    // console.log(
    ...
    const renderRes = newVNode.componentWrapper.update(newVNode.state.componentState, newVNode.props) || (0, jsx_1.createVBlank)(null);
...
// ------------------------------------------------------------
function patchChildren(parentDom, newVNodes, oldVNodes) {
    // TODO: diff and patch scheme should be considered for better performance
...
function patch(parentDom, newVNode, oldVNode) {
    ...
    else if (newVNode.vtype !== oldVNode.vtype ||
        (oldVNode.vtype === 'vElement' &&
            newVNode.vtype === 'vElement' &&
